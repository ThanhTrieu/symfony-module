...
class PostReviews
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="product_availability", type="integer", nullable=true, options={"comment"="Tình trạng - 0: None, 1: Discontinued, 2: InStock, 3: InStoreOnly, 4: LimitedAvailability, 5: OnlineOnly, 6: OutOfStock, 7: PreSale, 8: SoldOut"})
     */
    ...
    public function getProductAvailability(): ?int
    {
        return $this->productAvailability;
    }

    public function setProductAvailability(?int $productAvailability): self
    {
