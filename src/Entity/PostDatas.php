...
class PostDatas
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="content_source", type="text", length=0, nullable=true)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="content_mobile", type="text", length=0, nullable=true)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="content_amp", type="text", length=0, nullable=true)
     */
    private $contentAmp;
     ...
     * @var string|null
     *
     * @ORM\Column(name="related_posts", type="string", length=500, nullable=true, options={"comment"="Tin liên quan, post_id cách nhau dấu phẩy"})
     */
    ...
    public function getRelatedPosts(): ?string
    {
        return $this->relatedPosts;
    }

    public function setRelatedPosts(?string $relatedPosts): self
    {
