...
class GalleryImages
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="created_date", type="datetime", nullable=false, options={"default"="0000-00-00 00:00:00","comment"="Ngày tạo ảnh"})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="status", type="integer", nullable=false, options={"default"="1","comment"="Trạng thái ảnh, 0: Chưa duyệt, 1: Đã duyệt"})
     */
    private $status = '1';
