...
class GroupBoxes
{
     ...
     * @var int
     *
     * @ORM\Column(name="key", type="integer", nullable=false, options={"comment"="Khóa để hiển thị"})
     */
    private $key;
     ...
     * @var int
     *
     * @ORM\Column(name="type", type="integer", nullable=false, options={"comment"="0:Box short link, 1: Box full link, 2: Box posts"})
     */
    private $type = '0';
